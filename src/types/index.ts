...
// Información detallada de un punto de acupuntura
export interface PointDetail {
  // Ubicación anatómica detallada
  anatomicalLocation?: string;

  // Indicaciones clínicas por categoría
  indicationsRespiratory?: string[];
  indicationsLocal?: string[];
  indicationsGeneral?: string[];
  indicationsMental?: string[];

  // Clasificación energética
  energeticClassification?: string[];

  // Acciones energéticas (funciones MTCh)
  energeticActions?: string[];

  // Técnica de punción y seguridad
  punctureDirection?: string;
  punctureDepth?: string;
  moxa?: string;
  precautions?: string;
